...
// natively by the Tauri Native (src/native/tauri.ts), and in the browser build the same
// table is what keys.ts routes keydown through. Pure, so the README table is a test.
