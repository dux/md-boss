...
A chat pane, driven by the Claude Agent SDK, that can read the folder you have open and answer about the document you are looking at.
...
* The old Tauri and Swift roots - both removed; git history has them.
