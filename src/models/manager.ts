...
export class Manager {
   ...
   *  the sidebar at the top, as typed; a file opens. A git ancestor of the file's folder
   *  becomes the root when there is one; otherwise the file's folder is listed only when
   *  no root already holds it. What is not there is said by name, as AppDelegate did. */
